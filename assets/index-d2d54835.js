import{j as z,r as c,R as Z}from"./react-95444d27.js";import{c as V}from"./react-dom-aec6493c.js";import{L as ee,H as te}from"./react-router-dom-5eb82e95.js";import{q as ne,W as P}from"./react-helmet-async-862f3f71.js";import{s as d,W as ie}from"./styled-components-49ba3070.js";import{G as re,L as oe,B as ae,a as se,T as ce,A as le,R as de,S as pe,C as he,P as ue,b as me}from"./react-bootstrap-icons-1dca9ad3.js";import{i as fe,o as ge,G as N,g as xe,s as ye,A as j,U as F,a as be,O as ve,K as we,T as O,B as $,b as H,f as M,h as U,c as ke}from"./@firebase-fe145d92.js";import"./firebase-8b32cf63.js";import{a as T,O as Ce,d as J,N as E,e as Le,f as w}from"./react-router-dbf5362e.js";import{d as Se}from"./react-timer-hook-fc587190.js";import"./hoist-non-react-statics-b763826a.js";import"./scheduler-04ce0582.js";import"./@remix-run-ff1f5340.js";import"./prop-types-4d501b15.js";import"./react-fast-compare-8dea2db9.js";import"./invariant-c4c304c3.js";import"./shallowequal-6a8ebf1c.js";import"./react-is-d0c61868.js";import"./@emotion-3c1bd611.js";import"./tslib-4b8363ab.js";import"./idb-f62f60ab.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const h of o.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&a(h)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerpolicy&&(o.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?o.credentials="include":r.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();const L=z.Fragment,e=z.jsx,i=z.jsxs,S=({children:t})=>e(Ae,{children:t}),Ae=d.div`
  width: 100%;
  max-width: 1280px;
`,Re=d.footer`
  padding: 10px;
...
`,B=({levelId:t})=>{const[n,s]=c.useState(null);return c.useEffect(()=>{(async()=>{const r=await Be(t);s(r)})()},[t]),n?n.length?e(_e,{children:i(He,{children:[e("thead",{children:i("tr",{children:[e("th",{title:"position",children:"#"}),e("th",{children:"Name"}),e("th",{children:"Level"}),e("th",{children:"Points"}),e("th",{children:"Time"})]})}),e("tbody",{children:n.map((a,r)=>i("tr",{children:[i("td",{children:[e(le,{}),e("span",{children:r+1})]}),e("td",{children:a.player}),e("td",{children:a.level.name}),e("td",{children:a.points}),i("td",{children:[a.time.minutes<10?"0":null,a.time.minutes,":",a.time.seconds<10?"0":null,a.time.seconds]})]},a.id))})]})}):e(q,{children:e("h2",{children:"No games played yet"})}):e(q,{children:e("h2",{children:"Loading..."})})},Me="/react-find-them/assets/gamer-3f4bfe84.svg",Ue=()=>{const{user:t,signInGoogle:n}=c.useContext(A),s=T();return i(qe,{children:[e("h2",{children:"Can you find the characters fast?"}),e("p",{children:"Play some levels and make your way up the leaderboard"}),e("img",{src:Me,alt:"",width:"70%"}),t?e("button",{onClick:()=>s("/play"),children:"Play a level"}):e("button",{onClick:()=>n(),children:"Sign in with Google"})]})},qe=d.div`
  display: flex;
  flex-direction: column;
  background: var(--bg-0);
  color: #fff;
...
`,lt=({currentId:t})=>{const{levels:n}=c.useContext(f);return i(dt,{children:[e(Y,{level:{name:"All",id:"all"},current:t==="all"}),n.map(s=>e(Y,{level:s,current:t===s.id},s.id))]})},dt=d.div`
  ...
  gap: 4px;
  flex-wrap: wrap;
`,pt=()=>{let{levelId:t}=J();return t||(t=" "),i(L,{children:[i(P,{children:[e("title",{children:"Leaderboard"}),e("meta",{name:"description",content:"Ranking with the best players of each level"})]}),e(S,{children:i(ht,{children:[e(lt,{currentId:t}),e(B,{levelId:t})]})})]})},ht=d.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,ut=d.div`
...
`,gt=()=>{const{levels:t}=c.useContext(f),n=T(),s=a=>{n(`/play/${a.id}`)};return e(ft,{children:t.map(a=>e(mt,{level:a,onClick:()=>s(a)},a.id))})},xt=()=>{const{resetGame:t}=c.useContext(f),{user:n}=c.useContext(A);return c.useEffect(()=>{t()},[]),n?i(L,{children:[i(P,{children:[e("title",{children:"Select a level"}),e("meta",{name:"description",content:"Select a level to start playing"})]}),e(S,{children:e(gt,{})})]}):e(E,{to:"/"})},yt=()=>e(te,{children:e(Le,{children:i(w,{path:"/",element:e(Ee,{}),children:[e(w,{path:"",element:e(De,{})}),e(w,{path:"play",element:e(xt,{})}),e(w,{path:"play/:levelId",element:e(ot,{})}),e(w,{path:"ranking",element:e(E,{to:"/ranking/all"})}),e(w,{path:"ranking/:levelId",element:e(pt,{})}),e(w,{path:"*",element:e(Je,{})})]})})});V.createRoot(document.getElementById("root")).render(e(Z.StrictMode,{children:e(yt,{})}));
